...
export default function NewProductModalComponent({ openModalState, closeModalCallBack, onValidNewProductCallBack }) {
    ...
    >
      ...
      >
        ...
        <div className="px-6 pt-5 pb-2">
          <h2 className="text-lg font-semibold text-gray-900 dark:text-gray-100">New Product</h2>
        </div>
        ...
        <div className="px-6 py-3 border-t border-b border-gray-200 dark:border-gray-700">
          ...
          <form id="frm_create_new_product" onSubmit={handleFormSubmit} className="flex flex-col gap-3">
